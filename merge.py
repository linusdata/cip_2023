...
pd_imdb = pd.read_csv('imdb_top_250.csv')
...
cip.write_to_table(df=pd_joined, table_name="merged")

#dataframe als csv abspeichern
pd_joined.to_csv("merged.csv", index=False)
...
print("Der Korrelationskoeffizient zwischen 'Rating' und der Anzahl gewonnenen Oscars ist: " + str(cor_rating_oscars) + ". lorem ipsum.")
...
print("Der Korrelationskoeffizient zwischen 'Rating' und der 'mean_sentiment_score' ist: " + str(cor_sentiment_rating) + ". lorem ipsum.")
"""
