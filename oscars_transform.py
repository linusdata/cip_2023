...
#Lesen von Daten aus dem CSV "oscars_stage_1" und Speichern der Daten in einem dataframe
...
dtypes = ["INT", "VARCHAR(250)", "INT", "INT", "INT"]

#tabelle "oscars_stage_3" erstellen
cip.create_table("oscars_stage3", cols, dtypes)
#dataframe in neu erstellte tabelle schreiben
cip.write_to_table(df=df_oscars_final, table_name="oscars_stage3")